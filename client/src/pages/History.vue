  ...
  <div class="animate-fade-in">
      ...
      <div class="flex flex-col md:flex-row gap-3">
        ...
        <div class="flex-1 relative">
          ...
          <input
            ...
            class="w-full pl-10 pr-10 py-2.5 text-sm rounded-lg border border-gray-200 bg-gray-50
        ...
        <div class="md:w-44">
          <select
            v-model="sortBy"
            @change="onSortChange"
            class="w-full py-2.5 px-3 text-sm rounded-lg border border-gray-200 bg-gray-50
                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
    ...
    <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div v-for="i in 6" :key="i"
        class="bg-white rounded-xl border border-gray-100 p-5 animate-pulse shadow-sm">
